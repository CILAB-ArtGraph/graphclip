...
sbatch  -o gat2experiment.out -e gat2experiment.out --job-name gat2exp ./slurms/proposed_model/launch --parameters="./configs_cineca/proposed_model/gat/normal_clip_graph_gat2.yaml" --graph