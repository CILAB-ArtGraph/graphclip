...
class GraphIntegratedGradients(IntegratedGradients):
    ...
    def _attribute(
        ...
        graph: HeteroData,
        target: None | int | Tuple[int] | Tensor | List[Tuple[int]] | List[int] = None,
        additional_forward_args: Any = None,
        n_steps: int = 50,
        method: str = "gausslegendre",
        step_sizes_and_alphas: None | Tuple[List[float]] = None,
    ) -> Tuple[Tensor]:
