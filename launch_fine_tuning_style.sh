...
sbatch -o outs/baseline_style_prot_ft.out -e outs/baseline_style_prot_ft.out ./slurms/baselines/fine_tuning/launch --parameters="configs_cineca/baselines/style/normal_clip_fine_tuning_mistral_prototype.yaml"
